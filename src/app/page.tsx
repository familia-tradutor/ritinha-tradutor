      ...
      <div className="flex-1 relative bg-[#050507] flex items-center justify-center">
        {cameraImage && (
          <div className="fixed bottom-4 left-4 right-4 z-50 bg-black/90 backdrop-blur border border-yellow-500/30 rounded-2xl p-4 max-h- overflow-auto">
            <div className="flex justify-between items-center mb-3"><h3 className="text-yellow-400 font-bold">Foto escaneada</h3><button onClick={()=>{setCameraImage(null); setOcrOriginal(""); setOcrTranslated("")}} className="text-white/60">✕</button></div>
