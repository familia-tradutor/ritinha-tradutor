  ...
  return (
    <div className="min-h-screen bg-black text-white flex flex-col">
      ...
      <div className="flex-1 relative bg-[#050507] flex items-center justify-center">
        ...
        <img src="/globo-passaporte1.png?v=22" alt="R" className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w- h- object-contain opacity-40 pointer-events-none z-0" />
