  ...
  return (
    <div className="min-h-screen bg-black text-white flex flex-col">
      ...
      <div className="flex-1 relative bg-[#050507] flex items-center justify-center">
        ...
        <img src="/globo-passaporte-v2.png?v=2" alt="Ritinha" className={`absolute w- h- object-contain transition-all duration-700 ${isActive? "scale-110 animate-pulse" : "animate-[spin_60s_linear_infinite] opacity-90"}`} />
